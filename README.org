WarrenBuf is an overpowered text buffer for the web, managing billions^{[1]} of lines without bottleneck. It's ~3KB /(gzip+min)/ and zero-dependency but punches above its weight with editor features 
